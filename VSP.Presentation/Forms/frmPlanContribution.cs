...
{
	public partial class frmPlanContribution : Form, IMessageFilter
    {
        ...
        public PlanContribution CurrentPlanContribution;
        ...
        {
            if (String.IsNullOrWhiteSpace(txtContribution.Text))
            {
                MessageBox.Show("Error: Contribution string cannot be blank");
                return;
            }
            else
            {
                try
                {
                    CurrentPlanContribution.Contribution = Decimal.Parse(txtContribution.Text);
                }
                catch
                {
                    MessageBox.Show("Error: Contribution string not in decimal format");
                    return;
                }
            }
            ...
            else
            {
                try
                {
                    CurrentPlanContribution.AsOfDate = DateTime.Parse(txtAsOfDate.Text);
                }
                catch
                {
            ...
            CurrentPlanContribution.SaveRecordToDatabase(frmMain_Parent.CurrentUser.UserId);
            this.Close();
        }
