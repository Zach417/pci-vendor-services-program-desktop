...
{
	public partial class frmPlanParticipantsEligible : Form, IMessageFilter
    {
        ...
        public PlanParticipantsEligible CurrentPlanParticipantsEligible;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    CurrentPlanParticipantsEligible.ParticipantCount = int.Parse(txtParticipantCount.Text);
                }
                catch
                {
            ...
            else
            {
                try
                {
                    CurrentPlanParticipantsEligible.AsOfDate = DateTime.Parse(txtAsOfDate.Text);
                }
                catch
                {
