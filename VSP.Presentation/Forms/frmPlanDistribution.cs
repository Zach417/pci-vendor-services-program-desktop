...
{
	public partial class frmPlanDistribution : Form, IMessageFilter
    {
        ...
        public PlanDistribution CurrentPlanDistribution;
        ...
        {
            if (String.IsNullOrWhiteSpace(txtDistribution.Text))
            {
            ...
            else
            {
                try
                {
                    CurrentPlanDistribution.Distribution = Decimal.Parse(txtDistribution.Text);
                }
                catch
                {
                    MessageBox.Show("Error: Distribution string not in decimal format");
                    return;
                }
            }
            ...
            else
            {
                try
                {
                    CurrentPlanDistribution.AsOfDate = DateTime.Parse(txtAsOfDate.Text);
                }
                catch
                {
            ...
            CurrentPlanDistribution.SaveRecordToDatabase(frmMain_Parent.CurrentUser.UserId);
            this.Close();
        }
