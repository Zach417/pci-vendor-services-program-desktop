...
{
	public partial class frmSearchQuestion : Form, IMessageFilter
    {
        ...
        public SearchQuestion CurrentSearchQuestion;
        ...
        {
            CurrentSearchQuestion.SubjectValue = txtSubject.Text;

            if (cboAnswer.Text == "Yes")
            {
                CurrentSearchQuestion.AnswerValue = SqlBoolean.True;
            }
            else
            {
                CurrentSearchQuestion.AnswerValue = SqlBoolean.False;
            }

            CurrentSearchQuestion.SaveRecordToDatabase(frmMain_Parent.CurrentUser.UserId);
            this.Close();
        }
