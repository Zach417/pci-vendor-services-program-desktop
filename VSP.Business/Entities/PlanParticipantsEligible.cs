...
{
    public class PlanParticipantsEligible : DatabaseEntity
    {
        public Guid PlanId;
        public int ParticipantCount;
        public DateTime AsOfDate;

        private static string _tableName = "PlanParticipantsEligible";

        public PlanParticipantsEligible()
            : base(_tableName)
        {

        }

        public PlanParticipantsEligible(Guid primaryKey)
